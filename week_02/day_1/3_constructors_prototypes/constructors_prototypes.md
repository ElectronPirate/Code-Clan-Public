...
Ok so now we can get our Person and Pet to interact.

In real life, we would say "A person __has a__ pet"

So our Person will have a pet property as well as a name property. When we create an instance of the class Person, we pass it a Pet object.  
...
- Take the **shoppingBasket** and products from last week and create a ShoppingBasket constructor function and a Product constructor function.
